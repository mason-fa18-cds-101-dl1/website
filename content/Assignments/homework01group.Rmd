Title: Homework 1 (Group)
Author: Dr. Glasbrenner
Author_Image: https://www.gravatar.com/avatar/49802fdfa5a0e63b3d932a5179d41c1e
Date: 2018-10-15 23:59
Tags: homework
Slug: homework-1-group
Summary: Collaborate with your assigned group members to turn your individual submissions for Homework 1 into a data exploration report.
Show_summary: true
Show_link: true
...
[**Individual submissions due:** October 15, 2018 @ 11:59pm]{.h3}

::: {.no-bullets}
*   [`r icon_github` Github Classroom repo for **Homework 1 (Group)**][github-classroom-repo]
:::
...
Your primary task is to use the R Markdown file [homework_1_group.Rmd]{.monospace} to write up your group's answers to the homework assignment.
...
Read the section **[Fill out the [CONTRIBUTIONS.md]{.monospace} file](#fill-out-the-contributionsmd-file)** for more details on how this works.
...
::: {.no-bullets}
*   `r icon_square` Share and discuss your individual submissions for Homework 1 with your assigned group and come to a consensus about the correct answer for each question.

*   `r icon_square` As a group, decide who will be responsible for writing the answer to each question.

*   `r icon_square` **(Important)** Before you start, make a copy of [homework_1_group.Rmd]{.monospace} and **rename the copied file** to include your last name. For example, if your last name is Smith, then your file copy should be renamed to [homework_1_group_smith.Rmd]{.monospace}.
...
*   `r icon_square` Place your write-ups for your questions in your file. Again, if my last name was Smith, and I agreed to write-up the answers to questions 4, 5, and 6, then I would open up [homework_1_group_smith.Rmd]{.monospace} and put my answers there. When I'm done, I would save my file, then commit and push my work to GitHub.
:::

### How to edit and merge your answers into the group submission

While you will be writing your answers in separate files, eventually the group will need to merge in everyone's answers into the [homework_1_group.Rmd]{.monospace} document.
The following checklist may help with this:

::: {.no-bullets}
*   `r icon_square` Select an editor to be in charge of merging everyone's answers into the final document [homework_1_group.Rmd]{.monospace}. Because the editor needs to take care of extra work to prepare the document for submission, it is reasonable if he or she does not contribute write-ups for as many of the questions as the rest of the group (for example, if everyone else answers three questions, the editor may only answer two).
...
If you are not the editor, then you should not edit [homework_1_group.Rmd]{.monospace} either!
...
5.  On Blackboard, find the **Homework 1 (Group)** submission link for your group.
...
[github-classroom-repo]:     https://classroom.github.com/g/PgjOmK--
[hw1-original-instructions]: /assignments/homework-1/
