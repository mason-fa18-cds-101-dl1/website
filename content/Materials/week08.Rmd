...
::: {.no-bullets}
*   `r icon_pencil` &nbsp; [Homework 2]{.card-downloads-format}
:::
...
::: {.no-bullets}
*   [`r icon_laptop` &nbsp; [DataCamp exercises (Week 8)]{.card-downloads-format}][module-exercises]
:::
<div style="margin-bottom: 1em"></div>
...
::: {.no-bullets}
*   [`r icon_book` &nbsp; [Week 8 readings]{.card-downloads-format}][readings]
:::
<div style="margin-bottom: 1em"></div>
